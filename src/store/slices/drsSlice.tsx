...
interface DrsState {
  ...
  // Medicals Panel State
  medicalsPanelOpen: boolean;
...
const drsSlice = createSlice({
  ...
  reducers: {
    ...
    toggleMedicalsPanel: (state) => {
      state.medicalsPanelOpen = !state.medicalsPanelOpen;
    },
    setMedicalsPanelOpen: (state, action: PayloadAction<boolean>) => {
      state.medicalsPanelOpen = action.payload;
    },
